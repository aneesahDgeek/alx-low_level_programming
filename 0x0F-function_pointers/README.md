C - FUNCTION POINTERS Function pointers in C are variables that can store the memory address of functions and can be used in a program to create a function call to functions pointed by them.

TECHNOLOGIES C files are compiled on Ubuntu 20.04 using gcc C files are written according to the C90 standard All code checked using betty style All code written using vi editor

TASKS

What's my name mandatory Write a function that prints a name.
